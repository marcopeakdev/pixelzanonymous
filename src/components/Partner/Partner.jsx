  ...
  return (
    <React.Fragment>
      ...
      <div className="flex flex-col lg:flex-row justify-center gap-x-[50px] items-center py-12">
        ...
        <a
          href="https://twitter.com/AsteriaLabs"
          target="_blank"
          rel="noreferrer"
        >
          <img
        ...
        <a
          href="https://twitter.com/artificintelnft?s=21&amp;t=TtiFy3twBz9Gts3884mtFw"
          target="_blank"
          rel="noreferrer"
        >
          <img
        ...
        <a
          href="https://twitter.com/cheetopianft?s=21&amp;t=TtiFy3twBz9Gts3884mtFw"
          target="_blank"
          rel="noreferrer"
        >
          <img
